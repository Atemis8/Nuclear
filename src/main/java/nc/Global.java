...
public class Global {
    ...
    public static final String DEPENDENCIES = "required-after:forge@[14.23.5.2847,);after:tconstruct;after:conarm;after:openterraingenerator;after:alchemistry;after:harvestcraft";
